...
const styles = StyleSheet.create({
  ...
  profilePicture: {width: 50, height: 50, borderRadius: 100},
  normalMarginLeft: {marginLeft: 8},
  image: {width: '100%', height: 300},
  captionContainer: {margin: 8, flex: 1},
  text: {fontWeight: 'bold', fontSize: 16, textAlign: 'justify'},
